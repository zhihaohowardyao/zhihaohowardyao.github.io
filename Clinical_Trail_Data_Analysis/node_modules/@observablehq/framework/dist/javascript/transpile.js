...
function transpileJavaScript(node, { id, path, params, mode, resolveImport }) {
...
async function transpileModule(input, { root, path, params, resolveImport = getModuleResolver(root, path) }) {
